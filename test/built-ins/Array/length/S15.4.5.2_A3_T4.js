...
//CHECK#1
if (x[0] !== 0) {
  $ERROR('#1: x = [0,1,2]; x[1001] = 1001; x.length = 2; x[0] === 0. Actual: ' + (x[0]));
}

//CHECK#2
if (x[1] !== 1) {
  $ERROR('#2: x = [0,1,2]; x[1001] = 1001; x.length = 2; x[1] === 1. Actual: ' + (x[1]));
}

//CHECK#3
if (x[2] !== undefined) {
  $ERROR('#3: x = [0,1,2]; x[1001] = 1001; x.length = 2; x[2] === undefined. Actual: ' + (x[2]));
}

//CHECK#4
if (x[1001] !== undefined) {
  $ERROR('#4: x = [0,1,2]; x[1001] = 1001; x.length = 2; x[1001] === undefined. Actual: ' + (x[1001]));
}
